...
from models.resnet_encoders_semantic import resnet18_encoder_semantic
import pathlib
...
class GMM_VAE_Contrastive(pl.LightningModule):
    def __init__(
        ...
        **kwargs
        ...
        self.noise = noise
        valid_encoders = {
            'resnet18_semantic':{'enc':resnet18_encoder_semantic,'dec':None},
        }
    ...
    def test_step(self, batch, batch_idx):
        x, y = batch
        if self.enc_type == 'resnet18_semantic':
