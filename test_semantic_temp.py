...
matplotlib.use('Agg')
from models.vae_semantic_temp import GMM_VAE_Contrastive, UpdateMargin, InitializeGaussians
...
def cli_main(args=None):
    ...
    print(f"noise:{args.noise},transmit_dim:{args.transmit_dim},unknown:{args.unknown_dataset},enc_type:{args.enc_type},checkpoint:{args.checkpoint_path}")
    if args.max_steps == -1:
        args.max_steps = None
