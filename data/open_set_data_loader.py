...
def get_dict(class_num):   
    return {
        ...
        'imagenet-crop':lambda root,train,download,transform, **kwargs: ImageFolder("data/openset/Imagenet_resize", transform=transform),
        'lsun-resize':lambda root,train,download,transform, **kwargs: ImageFolder("data/openset/LSUN_resize", transform=transform),
        'lsun-crop':lambda root,train,download,transform, **kwargs: ImageFolder("data/openset/LSUN_resize", transform=transform)
    }    
