...
matplotlib.use('Agg')
from models.vae_semantic_temp_change_position import GMM_VAE_Contrastive, UpdateMargin, InitializeGaussians
...
def cli_main(args=None):
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        save_top_k=3,
        save_last=True,
        dirpath=f'checkpoints/{args.enc_type}/{script_args.known_dataset}/noise_{args.noise}/transmitdim_{args.transmit_dim}/version_2/',
