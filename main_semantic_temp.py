...
def cli_main(args=None):  
    ...
    tensorboard_logger = TensorBoardLogger("lightning_logs", name=f'{args.enc_type}/{script_args.known_dataset}_{script_args.unknown_dataset}/')
    ...
    trainer = pl.Trainer.from_argparse_args(args,callbacks=callbacks,logger=tensorboard_logger,reload_dataloaders_every_epoch=True)
