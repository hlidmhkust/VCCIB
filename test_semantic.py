...
import matplotlib
matplotlib.use('Agg')
from models.vae_semantic import GMM_VAE_Contrastive,UpdateMargin,InitializeGaussians
...
def cli_main(args=None):  
    ...
    trainer.test(model, dm.train_dataloader())#这一次是计算高斯，并且is_tested=1,然后return给下一次用 # First iteration will calculate Gaussians, second will do the test.
